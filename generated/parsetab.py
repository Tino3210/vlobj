...
_lr_productions = [
  ...
  ('statement -> randomNumber','statement',1,'p_statement','parserVLOBJ.py',42),
  ('statement -> color','statement',1,'p_statement','parserVLOBJ.py',43),
  ('statement -> expression','statement',1,'p_statement','parserVLOBJ.py',44),
  ('assignation -> IDENTIFIER EQUALS expression','assignation',3,'p_assignation','parserVLOBJ.py',52),
  ('assignation -> IDENTIFIER EQUALS randomNumber','assignation',3,'p_assignation','parserVLOBJ.py',53),
  ('randomShape -> XS PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','randomShape',10,'p_random_shape','parserVLOBJ.py',58),
  ('randomShape -> XS PAR_START expression COMMA expression COMMA expression COMMA expression COMMA expression PAR_END','randomShape',12,'p_random_shape','parserVLOBJ.py',59),
  ('randomNumber -> XD PAR_START expression COMMA expression PAR_END','randomNumber',6,'p_random_number','parserVLOBJ.py',69),
  ('square -> SQUARE PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','square',10,'p_square','parserVLOBJ.py',74),
  ('square -> SQUARE PAR_START expression COMMA expression COMMA expression COMMA expression COMMA expression PAR_END','square',12,'p_square','parserVLOBJ.py',75),
  ('pyramid -> PYRAMID PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','pyramid',10,'p_pyramid','parserVLOBJ.py',85),
  ('pyramid -> PYRAMID PAR_START expression COMMA expression COMMA expression COMMA expression COMMA expression PAR_END','pyramid',12,'p_pyramid','parserVLOBJ.py',86),
  ('color -> COLOR PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','color',10,'p_color','parserVLOBJ.py',96),
  ('structure -> WHILE PAR_START condition PAR_END ACOL_START programme ACOL_END','structure',7,'p_while','parserVLOBJ.py',102),
  ('structure -> IF PAR_START condition PAR_END ACOL_START programme ACOL_END','structure',7,'p_test','parserVLOBJ.py',107),
  ('structure -> IF PAR_START condition PAR_END ACOL_START programme ACOL_END ELSE ACOL_START programme ACOL_END','structure',11,'p_test','parserVLOBJ.py',108),
  ('condition -> expression CONDITION expression','condition',3,'p_condition','parserVLOBJ.py',116),
  ('expression -> IDENTIFIER ADD_OP UNDERSCORE ADD_OP','expression',4,'p_expression_increment','parserVLOBJ.py',121),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parserVLOBJ.py',126),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parserVLOBJ.py',127),
  ('expression -> ADD_OP expression','expression',2,'p_expression_uminus','parserVLOBJ.py',132),
  ('expression -> APO IDENTIFIER APO','expression',3,'p_expression_string','parserVLOBJ.py',136),
  ('expression -> NUMBER','expression',1,'p_expression_num','parserVLOBJ.py',140),
  ('expression -> IDENTIFIER','expression',1,'p_expression_IDENTIFIER','parserVLOBJ.py',145),
]
