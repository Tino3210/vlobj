...
_lr_productions = [
  ...
  ('programme -> statement','programme',1,'p_programme_statement','parserVLOBJ.py',30),
  ('programme -> statement DOTCOMMA programme','programme',3,'p_programme_recursive','parserVLOBJ.py',36),
  ('statement -> assignation','statement',1,'p_statement','parserVLOBJ.py',42),
  ('statement -> structure','statement',1,'p_statement','parserVLOBJ.py',43),
  ('statement -> square','statement',1,'p_statement','parserVLOBJ.py',44),
  ('statement -> pyramid','statement',1,'p_statement','parserVLOBJ.py',45),
  ('statement -> randomShape','statement',1,'p_statement','parserVLOBJ.py',46),
  ('statement -> randomNumber','statement',1,'p_statement','parserVLOBJ.py',47),
  ('statement -> color','statement',1,'p_statement','parserVLOBJ.py',48),
  ('statement -> expression','statement',1,'p_statement','parserVLOBJ.py',49),
  ('assignation -> IDENTIFIER EQUALS expression','assignation',3,'p_assignation','parserVLOBJ.py',57),
  ('assignation -> IDENTIFIER EQUALS randomNumber','assignation',3,'p_assignation','parserVLOBJ.py',58),
  ('randomShape -> XS PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','randomShape',10,'p_random_shape','parserVLOBJ.py',63),
  ('randomShape -> XS PAR_START expression COMMA expression COMMA expression COMMA expression COMMA expression PAR_END','randomShape',12,'p_random_shape','parserVLOBJ.py',64),
  ('randomNumber -> XD PAR_START expression COMMA expression PAR_END','randomNumber',6,'p_random_number','parserVLOBJ.py',74),
  ('square -> SQUARE PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','square',10,'p_square','parserVLOBJ.py',79),
  ('square -> SQUARE PAR_START expression COMMA expression COMMA expression COMMA expression COMMA expression PAR_END','square',12,'p_square','parserVLOBJ.py',80),
  ('pyramid -> PYRAMID PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','pyramid',10,'p_pyramid','parserVLOBJ.py',90),
  ('pyramid -> PYRAMID PAR_START expression COMMA expression COMMA expression COMMA expression COMMA expression PAR_END','pyramid',12,'p_pyramid','parserVLOBJ.py',91),
  ('color -> COLOR PAR_START expression COMMA expression COMMA expression COMMA expression PAR_END','color',10,'p_color','parserVLOBJ.py',101),
  ('structure -> WHILE PAR_START condition PAR_END ACOL_START programme ACOL_END','structure',7,'p_while','parserVLOBJ.py',107),
  ('structure -> IF PAR_START condition PAR_END ACOL_START programme ACOL_END','structure',7,'p_test','parserVLOBJ.py',112),
  ('structure -> IF PAR_START condition PAR_END ACOL_START programme ACOL_END ELSE ACOL_START programme ACOL_END','structure',11,'p_test','parserVLOBJ.py',113),
  ('condition -> expression CONDITION expression','condition',3,'p_condition','parserVLOBJ.py',121),
  ('expression -> IDENTIFIER ADD_OP UNDERSCORE ADD_OP','expression',4,'p_expression_increment','parserVLOBJ.py',126),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parserVLOBJ.py',131),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parserVLOBJ.py',132),
  ('expression -> ADD_OP expression','expression',2,'p_expression_uminus','parserVLOBJ.py',137),
  ('expression -> APO IDENTIFIER APO','expression',3,'p_expression_string','parserVLOBJ.py',142),
  ('expression -> NUMBER','expression',1,'p_expression_num','parserVLOBJ.py',147),
  ('expression -> IDENTIFIER','expression',1,'p_expression_IDENTIFIER','parserVLOBJ.py',152),
]
